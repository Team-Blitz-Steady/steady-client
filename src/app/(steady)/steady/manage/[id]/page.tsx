...
const SteadyManagePage = ({ params }: { params: { id: string } }) => {
  ...
  return (
    <div className="flex flex-col max-sm:w-400 sm:w-450 md:w-600 lg:w-800 xl:w-1000">
      <div className="mb-10 flex w-full items-center justify-between">
        <div className="font-bold max-sm:text-22 sm:text-22 md:text-25 lg:text-28 xl:text-30">
          <span className="text-st-primary">{steadyDetailsData.name}</span>
          <span> 스테디 운영</span>
        </div>
      ...
      <Tabs.Root
        ...
        className="flex flex-col overflow-x-hidden max-sm:w-400 sm:w-450 md:w-600 lg:w-800 xl:w-1000"
      >
        <Tabs.List className="flex w-full gap-10">
